...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("fail0verflow; Niels Westphal (crashniels); M H; rmuxnet");
MODULE_DESCRIPTION("Sony PS4 Aeolia/Belize south bridge PCIe core (composite MSI router)");
