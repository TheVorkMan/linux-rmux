...
/*
 * Panasonic MN86471A / MN864729 DP-to-HDMI bridge driver
 * (programmed via the PS4 Aeolia ICC interface)
 *
 * Reverse engineering and the original bridge sequences are the work of
 * fail0verflow; forward-ported and extended downstream by the ps4-linux
 * community (Niels Westphal / crashniels, feeRnt, rancido).
 */
